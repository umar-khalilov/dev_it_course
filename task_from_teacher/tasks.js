...
const textTruncate = (str, length = 100, ending = '...') => str.substring(0, length) + (length < 100 ? ending : '');
...
У каждого сотрудника должны быть обезательны следующие поля: Имя, Фамилия, Возраст, Телефон, Емейл, Ставка, Должность.
    При инициализации можно передать ввиде обьекта изначальные данные о "организационная структура компании".
