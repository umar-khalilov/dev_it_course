...
const menuItem = new MenuItem('test', 20, 30, 22, new Supplement('salad',
        30, 30),
    'lala');
...
//-----------------------------------------------------------------------------
const menuItem2 = new MenuItem('test2', 24, 35, 22, new Supplement('cheese',
        39, 44),
    'lala');
...
export const network = new FastFoodNetwork('My burger network', 'MCDon', king);
