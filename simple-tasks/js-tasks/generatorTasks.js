...
// 3. Написать кастомную функцию-генератор.
//    Который имитирует поля в реальном генераторе. Запускать нужно через функцию next()z
const customGen = {
    myGen(n = 10) {
        let i = 0;
        return {
...
// 8. Написать функцию, которая "размораживает" замороженный объект
//    (принимает замороженный объект, возвращает новый, содержащий свойства замороженного)
...
// 9. Написать функцию, которая принимает массив объектов и возвращает новый объект,
//    содержащий все свойства переданных объектов. Синтаксис: arrToObj(arr: object[]): object
